...
public class StoreManagerHome extends HttpServlet {
    ...
    private void displayStoreManagerHome(HttpServletRequest request,HttpServletResponse response, PrintWriter pw, String flag)
    {
        ...
        "<option value='pettracker' name='pettracker'>PetTracker</option>" +
        "<option value='vrs' name='vrs'>Virtual Reality</option>" +
        ...
        pw.print("<form method='post' action='RemoveUpdateProduct'>");
        pw.print("<tr>");
       // pw.print("<td><input type='radio' name='productId' value='" + voiceassistant.getId() + "'></td>");
		...
		//VirtualReality
		for (Map.Entry<String, VirtualReality> entry : SaxParserDataStore.virtualreality.entrySet()) {
       ...
       // pw.print("<td><input type='radio' name='productId' value='" + voiceassistant.getId() + "'></td>");
        ...
        pw.print("<input type='hidden' name='productCatalog' value='vrs'>");
        ...
        PetTracker pt = entry.getValue();
        pw.print("<form method='post' action='RemoveUpdateProduct'>");
        pw.print("<tr>");
        // pw.print("<td><input type='radio' name='productId' value='" + pt.getId() + "'></td>");

        pw.print("<td>" + pt.getName() + "</td>" +
        "<td>" + pt.getPrice() + "</td>" +
        //  "<td>" + pt.getRetailer() + "</td>" +
        "<td>" + pt.getCondition() + "</td>" +
        "<td>" + pt.getDiscount() + "</td>" +
        "<td>Pet Trackers</td>");
        pw.print("<input type='hidden' name='productId' value='" + pt.getId() + "'>");
        pw.print("<input type='hidden' name='productName' value='" + pt.getName() + "'>");
        pw.print("<input type='hidden' name='price' value='" + pt.getPrice() + "'>");
        //pw.print("<input type='hidden' name='manufacturer' value='" + pt.getRetailer() + "'>");
        pw.print("<input type='hidden' name='condition' value='" + pt.getCondition() + "'>");
        pw.print("<input type='hidden' name='discount' value='" + pt.getDiscount() + "'>");
        pw.print("<input type='hidden' name='productCatalog' value='pettracker'>");
        pw.print("<input type='hidden' name='image' value='" + pt.getImage() + "'>");
        pw.print("</tr>");
        pw.print("<tr>");
        pw.print("<td><div align=\"left\" style=\"float:left\"><input type='submit' name='Product' value='Update' class='btnbuy'></div></td>");
        pw.print("<td>");
