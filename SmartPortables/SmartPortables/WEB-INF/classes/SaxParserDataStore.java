...
public class SaxParserDataStore extends DefaultHandler {
	...
	static HashMap<String,VirtualReality> virtualreality;
	...
	virtualreality = new HashMap<String, VirtualReality>();
...
////////////////////////////////////////////////////////////
    ...
    public void startElement(String str1, String str2, String elementName, Attributes attributes) throws SAXException {
		...
		if (elementName.equalsIgnoreCase("vrs")) 
		{
			currentElement="vrs";
			vrs = new VirtualReality();
            vrs.setId(attributes.getValue("id"));
		}
    ...
    public void endElement(String str1, String str2, String element) throws SAXException {
		...
		if (element.equals("vrs")) {
			virtualreality.put(vrs.getId(),vrs);
			return;
		}
        ...
        if (element.equalsIgnoreCase("image")) {
			...
			if(currentElement.equals("vrs"))
				vrs.setImage(elementValueRead);  
		...
		if (element.equalsIgnoreCase("discount")) {
			...
			if(currentElement.equals("vrs"))
				vrs.setDiscount(Double.parseDouble(elementValueRead)); 
			if(currentElement.equals("pettracker"))
		...
		if (element.equalsIgnoreCase("condition")) {
			...
			if(currentElement.equals("vrs"))
				vrs.setCondition(elementValueRead);
			if(currentElement.equals("pettracker"))
		...
		if (element.equalsIgnoreCase("manufacturer")) {
			...
			if(currentElement.equals("vrs"))
				vrs.setRetailer(elementValueRead);
			if(currentElement.equals("pettracker"))
        ...
        if(element.equalsIgnoreCase("price")){
			...
			if(currentElement.equals("vrs"))
				vrs.setPrice(Double.parseDouble(elementValueRead));
			if(currentElement.equals("pettracker"))
